...
public class BalconyArrangement3 extends PApplet {
    public static void main(String[] args) {
        PApplet.main("Balcony.BalconyArrangement3");
    }
    ...
    public void setup(){
        ...
        balcony_0=new Balcony(1,1,0,1,2,20,1,this);
        AllBalcony.add( balcony_0);
        balcony_1=new BalconyOtherType_1(2,2,1,3,5,30,4,this);
        AllBalcony.add( balcony_1);
        balcony_2=new BalconyOtherType_2(2,2,2,3,5,30,4,this);
        AllBalcony.add( balcony_2);
        balcony_3=new Balcony(1,2,3,2,8,20,3,this);
        ...
        camera = new PeasyCam(this,0.25*width,0.5*height,-0.5*x_facade2,50);
    }
...
//        }
    ...
    public void drawBalcony(){             //画出阳台
        ...
        pushMatrix();
        translate( (c+x_facade1)*size,0,0);
        rotate(0.5f*PI,0,1,0);
        translate( -(c+x_facade1)*size,0,0);
        for (int i = c+x_facade1; i < c+x_facade1+x_facade2; i++) {
            for (int j = c; j < y_num-c+1 ; j++) {
                fill(255);
        ...
        pushMatrix();
        translate( (c+x_facade1)*size,0,-x_facade2*size);
        rotate(PI,0,1,0);
        translate( -(c+x_facade1+x_facade2)*size,0,0);
        for (int i = c+x_facade1+x_facade2; i < c+2*x_facade1+x_facade2; i++) {
            for (int j = c; j < y_num-c+1 ; j++) {
                fill(255);
                rect(i * size, j * size, size, size);
            }
        ...
        pushMatrix();
        translate( c*size,0,-x_facade2*size);
        rotate(1.5f*PI,0,1,0);
        translate( -(c+2*x_facade1+x_facade2)*size,0,0);
        for (int i = c+2*x_facade1+x_facade2; i < c+2*x_facade1+2*x_facade2; i++) {
            for (int j = c; j < y_num-c+1 ; j++) {
                fill(255);
                rect(i * size, j * size, size, size);
            }
