...
public class Graph {
    ...
    public ArrayList<Integer>adj(int index){
    ...
    public static Graph getGraph(PApplet app,int width,int height,int[][]edges){
//        ArrayList<int[]>cities=readTxtFile(filename);
        ...
        System.out.println("size1: "+index.size());
        for(int i=0;i<edges_.length;i++){
        ...
        System.out.println("size2: "+index.size());
        ...
        for(int i=0;i<edges_.length;i++){
            System.out.println(edges[i][0]);
            System.out.println("start id: "+getNodeID(nodes_, edges[i][0]));
            System.out.println(edges[i][1]);
            System.out.println("end id: "+getNodeID(nodes_, edges[i][1]));
            if(edges[i].length==2) {
...
//                System.out.println("index :  "+nodes_[i].index+" is ok!");
            }
        }
        return index;
    }
